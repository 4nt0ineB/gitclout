...
***This GitClout app is an ongoing re-implementation of the original [GitClout app](https://gitlab.com/4nt0ineB/sebbah-bastos) developped by [val.sebb](https://gitlab.com/val.sebb) and me,***
